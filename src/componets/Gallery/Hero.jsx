...
const Hero = () => {
  return (
    <section className="relative flex items-center justify-center min-h-[90vh] w-screen  py-25">
      ...
      {/* 🌫️ Soft Overlay for Better Text Contrast */}
      <div className="absolute inset-0 bg-linear-to-t from-black/70 via-black/60 to-transparent"></div>
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto space-y-8">
        ...
        >
          ...
          through therapy, family, education, and emotional connection.
          Discover the warmth, care, and stories that inspire this movement.
        </p>
